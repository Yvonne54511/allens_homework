...
public partial class ISpanDemoContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Categori__3214EC07B57C1666");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Members__3214EC07572F85D0");

            entity.HasIndex(e => e.Account, "UX_Members_Account").IsUnique();

            entity.Property(e => e.Id).HasComment("處理進度:新訂單、已取消、已送達、已退貨");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Orders__3214EC079DB62DF2");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__OrderDet__3214EC0718084E63");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Products__3214EC07548531B5");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Supplier__3214EC076284B3F1");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Supplier__3214EC07DE6F5D70");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Supplier__3214EC078CD5637B");
